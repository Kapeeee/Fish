...
<title>Factor - Facturas Factorizadas</title>
<?php
...
function mod(hold) {
     ...
     $.ajax({
      url: '../controles/control_Cargar_Facturas2.php',
      type: 'POST',
      data: {"hold":hold},
      dataType:'json',
...
<div class="row">
            <div class="col-12 text-center">
                        <h3>Factorizadas - Vigentes y en Mora&nbsp;&nbsp;<i class="fa fa-print" aria-hidden="true"></i>
                        </h3>
                        <hr>
                  </div>
            </div>
  ...
  <div id="loading" style="display: none;">
    ...
    <form id="formTraeFact" onsubmit="return false;"  >
      ...
      <div class="row">
            ...
            <div class="col-6">           
                    <label for="vigencia">Estado de Factura&nbsp;:</label>                          
                            <select class="form-control" id="vigencia" name="vigencia" style="" onchange="">
                                <option value="" selected disabled>Seleccione Estado</option>
                                <option value="1">Vigente</option>
                                <option value="0">Morosa</option>
                            </select>
