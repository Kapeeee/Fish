...
<div class="container" id="main">
  ...
  <div id="loading" style="display: none;">
    ...
    <div class="col-12">
      <select class="form-control" id="cli" name="cli" style="width: 500px" onchange="modcli(this.value)">
  ...
  <div class="col-6">
        ...
        <input type="text"  class="form-control" id="plazopago" name="plazopago" maxlength="2" placeholder="Plazo de Pago" required>
        </div>
        <div class="form-group">
